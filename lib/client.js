...
try {
    ...
    console.log("Connected to the SIGMA_MD Whatsapp Bot By wasi")
} catch {
...
setTimeout(() => {
    ...
    global.sgc = 'https://chat.whatsapp.com/IcqWhTW0vgw4A4N1IPA03J'
    global.srepo = 'https://github.com/itxwasi/wasi-md'
    global.scap = '*⤹★ᴘᴏᴡᴇʀᴇᴅ ʙʏ★⤸ wasi ᴹᴰ* '
